...
async function loadHomeData() {
    ...
    // ────────────────────────────────────────────────────────────────
    // FIXED: Move these lines to the TOP — now Holders always updates
    // even if contracts are null or fail
    // ────────────────────────────────────────────────────────────────
    const holdersEl = document.getElementById('holders');
    if (holdersEl) {
        holdersEl.textContent = 'N/A';  // Safe default
    }
    ...
    try {
        ...
        // Calculate circulating (total - staked)
        ...
        // Holders is already set to N/A above — no need to repeat
    }
}
